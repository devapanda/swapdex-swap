...
import SlippageMenu from "../../components/swap/SlippageMenu";
import {AdvancedSwapDetails} from "../../components/swap/AdvancedSwapDetails";
import {isMobile} from "react-device-detect";
import Modal from "../../components/Modal";
import {AssetsCurrencies} from "../../components/AssetsCurrencies";
...
export default function Swap() {
  ...
  return (
    <>
      ...
      />
      <AppBody>
        <Wrapper id="swap-page" style={{ width: '75%' }}>
          ...
          <AssetsHeader>
            <WalletCircle>
              <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64">
                <g id="Эллипс_1164" data-name="Эллипс 1164" fill="none" stroke="#fff" strokeWidth="2">
                  <circle cx="32" cy="32" r="32" stroke="none"/>
                  <circle cx="32" cy="32" r="31" fill="none"/>
                </g>
              </svg>
              <svg xmlns="http://www.w3.org/2000/svg" width="32.043" height="30.357" style={{ position: "absolute", top: '25%', left: '25%' }}>
                <path id="Icon_material-account-balance-wallet" data-name="Icon material-account-balance-wallet"
                      d="M34.857,29.8v1.686a3.383,3.383,0,0,1-3.373,3.373H7.873A3.372,3.372,0,0,1,4.5,31.484V7.873A3.372,3.372,0,0,1,7.873,4.5H31.484a3.383,3.383,0,0,1,3.373,3.373V9.559H19.678a3.372,3.372,0,0,0-3.373,3.373V26.424A3.372,3.372,0,0,0,19.678,29.8ZM19.678,26.424H36.543V12.932H19.678Zm6.746-4.216a2.53,2.53,0,1,1,2.53-2.53A2.526,2.526,0,0,1,26.424,22.208Z"
                      transform="translate(-4.5 -4.5)" fill="#fff"/>
              </svg>
            </WalletCircle>
          </AssetsHeader>
          <AssetsContent>
            <p style={{ fontSize: '1.25rem' }}>Assets</p>
            <AssetsCurrencies />
          </AssetsContent>
        </AssetsWrapper>
      </AppBody>
